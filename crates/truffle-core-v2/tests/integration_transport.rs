//! Integration tests for truffle-core-v2 Layer 4 (Transport).
//!
...
//!
//! ```bash
//! cargo test -p truffle-core-v2 --test integration_transport -- --ignored --nocapture
//! ```
